...
//   ResponsiveContainer,
// } from "recharts";
// import { listIncome } from "../../api/incomeAPI"; // ✅ use your API
...
//         amount: total,  // total per category
//       }));
...
//   ResponsiveContainer,
// } from "recharts";
// import { listIncome } from "../../api/incomeAPI"; // ✅ your API
...
//       data.forEach((income) => {
//         const date = new Date(income.date).toLocaleDateString(); // group by day
//         const category = income.category;
//         const amount = parseFloat(income.amount);
...
//                 dataKey={cat}
//                 stackId="a"
//                 fill={`hsl(${(i * 50) % 360}, 70%, 50%)`} // different color per category
//               />
//             ))}
//           </BarChart>
//         </ResponsiveContainer>
